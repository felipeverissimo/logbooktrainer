...
const ExercisesForm = () => {
  ...
  const options = [
    ...
    {
      value: "Máquina de Flexão de Pernas",
      label: "Máquina de Flexão de Pernas",
    },
    ...
    {
      value: "Máquina de Agachamento Smith",
      label: "Máquina de Agachamento Smith",
    },
  ...
  const handleRefreshComponent = async () => {
    try {
      if (params.id !== "new") {
        ...
        const { data, notas, peso, repeticao, tipoExercicio } =
          await response.json();
      ...
      <div key={counterOption} className={styles.flexCenter}>
        ...
        <div className={styles.cardListLarge}>
          ...
          <div>
            ...
            <Select
              id="tipoExercicioSelect"
              aria-labelledby="tipoExercicioSelect"
              options={options}
              value={selectedOption}
              onChange={handleSelectChange}
            />
            <span className={styles.errorMessage}>
              {errorMessages.tipoExercicio}
            </span>
          </div>
          ...
          <div>
            ...
            />
            <span className={styles.errorMessage}>
              {errorMessages.repeticao}
            </span>
          </div>

          <div>
            <label htmlFor="notasTextarea">Notas pessoais</label>
            <TextArea
              id="notasTextarea"
              key={counterNotes}
              text={notes}
